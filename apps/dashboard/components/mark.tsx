/**
 * MpcKit brand mark. M flowing into K through a shared vertical stroke;
 * the K's diagonals are picked out in the brand teal so the monogram
 * reads as "MK" without spelling it out.
 */
type Props = {
  size?: number;
  className?: string;
